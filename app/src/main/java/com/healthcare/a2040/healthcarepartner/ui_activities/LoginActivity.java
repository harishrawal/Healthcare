...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSharedPref = new MSharedPref(getApplicationContext());
        ...
        TextView signUpTVButton = findViewById(R.id.signUpTV);
        signUpTVButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {

                startActivity(new Intent(LoginActivity.this, StepperSignupActivity.class));
                finish();
            }
        });

        //  signUpTVButton.setVisibility(View.GONE);
